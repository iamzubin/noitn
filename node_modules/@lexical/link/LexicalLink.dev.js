...
function registerLink(editor, stores) {
  return utils.mergeRegister(editor.registerNodeTransform(LinkNode, $linkNodeTransform), extension.effect(() => editor.registerCommand(TOGGLE_LINK_COMMAND, payload => {
