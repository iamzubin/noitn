...
import { useLexicalComposerContext } from "./@lexical_react_LexicalComposerContext.js";
import { defineExtension, mergeRegister } from "./lexical.js";
import "./LexicalUtils.dev-D4tcRpwR.js";
import "./LexicalClipboard.dev-BEnhpcKA.js";
import { n as LexicalBuilder } from "./LexicalExtension.dev-W5eeLbrY.js";
import { d as registerDragonSupport, u as registerRichText } from "./LexicalRichText.dev-BTlyG67g.js";
import { t as require_react_dom } from "./react-dom.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as $canShowPlaceholderCurry } from "./LexicalText.dev-1WZzRW4I.js";
//#region node_modules/@lexical/react/useLexicalEditable.dev.mjs
/**
...
*
*/
var useLayoutEffectImpl$1 = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react.useLayoutEffect : import_react.useEffect;
/**
* Copyright (c) Meta Platforms, Inc. and affiliates.
*
* This source code is licensed under the MIT license found in the
...
function useLexicalSubscription(subscription) {
	...
	const initializedSubscription = (0, import_react.useMemo)(() => subscription(editor), [editor, subscription]);
...
//#endregion
//#region node_modules/@lexical/react/LexicalReactProviderExtension.dev.mjs
/**
* Copyright (c) Meta Platforms, Inc. and affiliates.
*
* This source code is licensed under the MIT license found in the
...
*/
var ReactProviderExtension = defineExtension({ name: "@lexical/react/ReactProvider" });
//#endregion
//#region node_modules/@lexical/react/LexicalRichTextPlugin.dev.mjs
/**
* Copyright (c) Meta Platforms, Inc. and affiliates.
*
* This source code is licensed under the MIT license found in the
...
*
*/
var useLayoutEffectImpl = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react.useLayoutEffect : import_react.useEffect;
/**
* Copyright (c) Meta Platforms, Inc. and affiliates.
*
* This source code is licensed under the MIT license found in the
...
function useDecorators(editor, ErrorBoundary) {
	...
	return (0, import_react.useMemo)(() => {
		...
		for (let i = 0; i < decoratorKeys.length; i++) {
			...
			if (element !== null) decoratedPortals.push(/* @__PURE__ */ (0, import_react_dom.createPortal)(reactDecorator, element, nodeKey));
		}
...
function isUsingReactExtension(editor) {
	...
	if (builder && builder.hasExtensionByName(ReactProviderExtension.name)) {
		for (const name of ["@lexical/plain-text", "@lexical/rich-text"]) if (!!builder.hasExtensionByName(name)) formatDevErrorMessage(`LexicalBuilder: @lexical/react legacy text plugins conflict with the ${name} extension. Remove the legacy <RichTextPlugin/> or <PlainTextPlugin/> component.`);
		return true;
	}
	return false;
}
...
function LegacyDecorators({ editor, ErrorBoundary }) {
	return isUsingReactExtension(editor) ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Decorators, {
		editor,
		ErrorBoundary
	});
}
...
*
*/
function RichTextPlugin({ contentEditable, placeholder = null, ErrorBoundary }) {
	const [editor] = useLexicalComposerContext();
	useRichTextSetup(editor);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		contentEditable,
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Placeholder, { content: placeholder }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LegacyDecorators, {
			editor,
			ErrorBoundary
		})
	] });
...
function Placeholder({ content }) {
	...
	if (typeof content === "function") return content(editable);
	else return content;
}
//#endregion
