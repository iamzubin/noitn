...
import { $isRangeSelection, $isRootNode, $isTextNode, CAN_REDO_COMMAND, CAN_UNDO_COMMAND, CLEAR_EDITOR_COMMAND, CLEAR_HISTORY_COMMAND, HISTORIC_TAG, HISTORY_PUSH_TAG, REDO_COMMAND, UNDO_COMMAND, configExtension, defineExtension, mergeRegister, safeCast } from "./lexical.js";
import "./LexicalUtils.dev-DIOzt3tU.js";
import { a as o, i as namedSignals, r as getPeerDependencyFromEditor, t as E } from "./LexicalExtension.dev-Bef7_d6u.js";
import { useLexicalComposerContext } from "./@lexical_react_LexicalComposerContext.js";
//#region node_modules/@lexical/history/LexicalHistory.dev.mjs
/**
...
*/
var HistoryExtension = defineExtension({
	...
	register: (editor, config, state) => {
		...
		return E(() => stores.disabled.value ? void 0 : registerHistory(editor, stores.historyState.value, stores.delay));
	}
});
...
//#endregion
//#region node_modules/@lexical/react/LexicalHistoryPlugin.dev.mjs
/**
* Copyright (c) Meta Platforms, Inc. and affiliates.
*
* This source code is licensed under the MIT license found in the
...
function useHistory(editor, externalHistoryState, delay = 1e3) {
	const historyState = (0, import_react.useMemo)(() => externalHistoryState || createEmptyHistoryState(), [externalHistoryState]);
